...
<!-- hsl(cor/matiz, saturação, luminosidade)  -->
...
<!-- relativo á fonde original do elemento
(2em = 2 * tamanho original da fonte) -->
...
<!--
vw 1% da largura da janela do browser
vh 1% da altura da janela do browser
-->
...
<!-- text-shadow: sombra horizontal, sombra vertical, cor -->
...
<!-- Relativo á sua posição da viewport (nunca muda de posição, nem com scoll) -->
...
<!-- Utilizado para overlap de elementos -->
...
<!-- A posição é baseada no scroll do utilzador -->
